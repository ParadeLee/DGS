...
def train(args):
    ...
    logdir = 'logs/{}/{}_tasks/{}'.format(args['dataset'], args['total_sessions'], args['model_name'])
    args['logdir'] = logdir
    if not os.path.exists(logdir):
        os.makedirs(logdir)
    timestamp = datetime.now().strftime('%m%d_%H%M')
    args['timestamp'] = timestamp
    logfilename = os.path.join(logdir, '{}_t{}'.format(args['prefix'], timestamp))
    logging.basicConfig(
        level=logging.INFO,
    ...
    tblogdir = 'logs/{}/{}_tasks/{}/tb/'.format(args['dataset'], args['total_sessions'], args['model_name'])
    args['tblogdir'] = tblogdir
    print(logfilename)
